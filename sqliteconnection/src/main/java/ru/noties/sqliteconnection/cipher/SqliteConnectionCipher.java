...
class SqliteConnectionCipher extends SqliteConnectionBase {

    // connection should NEVER close database

    private final SQLiteDatabase mDatabase;

    SqliteConnectionCipher(SQLiteDatabase database) {
        mDatabase = database;
    }
    ...
    public void beginTransactionNonExclusive() {
        // sqlcipher does not support such a method
        // we will just redirect to the `beginTransaction` method
        mDatabase.beginTransaction();
    }
